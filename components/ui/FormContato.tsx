...
export function FormContato() {
  ...
  return (
    <section id="contato" className="py-20 sm:py-28" style={{ background: "#F5F7FA" }}>
      <div className="mx-auto max-w-2xl px-4 sm:px-6">
        ...
        >
          ...
          <div
            ...
            style={{ background: "#EBF4FF", border: "1px solid #BEE3F8", color: "#2A4365" }}
          >
          ...
          {status === "ok" ? (
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="contato">
